...
# FILES
# =============================================================================
main = r"YOUR FILE PATH" #change to your file path here
files = {
    "psiBLAST":
    ...
    "clustal": main+r"clustal1/",
    "clustal2": main+r"clustal2",
    "clustal3": main+r"clustal3/",
...
def clustal_analysis(DATA, start0, end0):
    ...
    PROPEPTIDES = list(BLAST["propeptide"].unique())
    HITS = {}
    if start0 is None: start0 = 0
    if end0 is None: end0 = 0
    for PROPEPTIDE in PROPEPTIDES:
        ...
        if match is not None:
            start = int(match.span()[0])-start0
            end = int(match.span()[1])+end0
            matches = {}
...
### creates longer logo
psiBLAST_filtered3 = load_backup(main+"summary/psiBLAST_filtered3_ensemble_propeptides_hits.xlsx")
psiBLAST_filtered2 = filter_organisms(psiBLAST_filtered3)
psiBLAST7 = read_clustal(psiBLAST_filtered2, "", files["clustal3"])
psiBLAST8 = clustal_analysis(psiBLAST7, 10, 6) #number of amino acids before and after original motif
psiBLAST_3_motif_FASTA = create_fasta(psiBLAST8)
create_weblogo(psiBLAST_3_motif_FASTA, "plots_longer_motif") #final logo

psiBLAST8 = clustal_analysis(psiBLAST7, 4, 0)
psiBLAST_3_motif_FASTA = create_fasta(psiBLAST8) #number of amino acids before and after original motif
create_weblogo(psiBLAST_3_motif_FASTA, "plots_longer_motif2") #final logo
